...
public class TwilightHoeItem extends HoeItem {

    public TwilightHoeItem(int i, float f, Settings settings) {
        super(new TwilightToolMaterial(), i, f, settings);
    }

    @Override
    public Text getName() {
        return ChatFormatter.stringFormatToText("&6Twilight Hoe");
    }
